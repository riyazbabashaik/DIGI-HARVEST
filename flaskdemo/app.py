...
filepath ='C:/Users/SHAIK RIYAZ BABA/Desktop/flaskdemo/Trained_model.h5'
...
fpath = 'C:/Users/SHAIK RIYAZ BABA/Desktop/flaskdemo/Plant-Seedlings-Classification-master/model_weight_Adam.hdf5'
...
app.config['MYSQL_PASSWORD'] = 'Riyaz@2304'
...
def predict():
    if request.method == 'POST':
        ...
        file_path = os.path.join('C:/Users/SHAIK RIYAZ BABA/Desktop/flaskdemo/static/user uploaded/', filename)
        file.save(file_path)
...
def predictweed():
    if request.method == 'POST':
        ...
        file_path = os.path.join('C:/Users/SHAIK RIYAZ BABA/Desktop/flaskdemo/UPLOADING PHOTOS/', filename)
        file.save(file_path)
